...
private:
  ...
  bool
      m_saddle_or_boundary; // it is true if total adjacent angle is larger than
                            // 2*PI or this vertex belongs to the mesh boundary
};
...
private:
  double m_corner_angles[3]; // triangle angles in radians; angles correspond to
                             // vertices in m_adjacent_vertices
};
...
public:
  ...
  SurfacePoint(face_pointer f, double alpha = 1. / 3., double beta = 1. / 3.,
               double gamma = 1. / 3.)
